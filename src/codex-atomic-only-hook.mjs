...
const NON_MUTATING_MCP_RE =
  /^mcp__(?:chrome[-_]devtools|context7|sequential[-_]thinking|codegraph|codebody[-_]navigator|lsp[-_]mesh|graphify[-_]plus|pulse|cognitive[-_]hub|test[-_]runner|task[-_]graph|sentry[-_]bridge)(?:\.|__)/;
